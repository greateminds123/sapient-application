package com.dell.springboot.config;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.dell.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.dell.springboot.model" });
